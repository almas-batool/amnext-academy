...
const faqs = [
  { q: "Are the certificates recognised by employers?",                  a: "Yes. Each certificate has a unique verifiable ID that employers can check at MindScrapper.dev/verify. The certificate includes your name, course, score, and date." },

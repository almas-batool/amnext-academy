...
const DEFAULT_CODE: Record<SupportedLanguage, string> = {
  javascript: `console.log("Hello MindScrapper");`,

  typescript: `console.log("Hello MindScrapper");`,

  python: `print("Hello MindScrapper")`,

  java: `
public class Main {
    public static void main(String[] args){
        System.out.println("Hello MindScrapper");
    }
}
`,
...
func main() {
    fmt.Println("Hello MindScrapper")
}
`,

  rust: `
fn main() {
    println!("Hello MindScrapper");
}
`,

  php: `
<?php
echo "Hello MindScrapper";
?>
`,
};
